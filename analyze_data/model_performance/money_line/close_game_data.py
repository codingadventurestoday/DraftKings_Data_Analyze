...
# data for all games 
close_report = make_classification_report(y_true, y_pred)

print("Accuracy: ", close_report.accuracy)
print("Precision: ", close_report.precison)
print("Recall: ", close_report.recall)
print("F1: ", close_report.f1)